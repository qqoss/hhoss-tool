...
/*
 * import net.sf.cglib.proxy.Callback; import net.sf.cglib.proxy.CallbackFilter; import net.sf.cglib.proxy.Enhancer; import net.sf.cglib.proxy.MethodInterceptor; import
 * net.sf.cglib.proxy.MethodProxy; import net.sf.cglib.proxy.NoOp;
 */
...
public class ProxyUtil {
  ...
  public static <T> T getObject(Object obj, Class<T> clazz) {
    ...
    /*
     * enhancer.setCallbacks(new Callback[]{new MethodInterceptorImpl(obj), NoOp.INSTANCE}); enhancer.setCallbackFilter(new CallbackFilter() {
     * 
     * @Override //返回Callbacks的索引 public int accept(Method method) { //对x方法不拦截 if (method.getName().equals("x")) return 1; return 0; } });
     */
  ...
  protected static org.slf4j.Logger getLogger() {
    org.slf4j.Logger logger = LoggerFactory.getLogger(Classes.caller());
